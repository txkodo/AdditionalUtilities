setblock ~ 0 ~ barrel
execute if data storage adu:items planter{harvested:1b} run loot replace block ~ 0 ~ container.2 loot adu:crops/beetroot
...
execute unless score @s adu.planter matches 0 run scoreboard players add @s adu.planter 64
