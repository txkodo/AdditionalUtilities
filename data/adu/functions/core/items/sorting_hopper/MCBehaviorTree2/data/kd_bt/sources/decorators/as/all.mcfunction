...
data modify storage {DATA}.-result set value 1
...
execute unless score $result kd_bt matches 0 store result score $result kd_bt run data get storage {DATA}.-result
...
execute unless score $result kd_bt matches 0 run function {NS}:{DIR}{SELF}.do.e1
